...
# 6. Set up the job array.  In this instance we have requested 10000 tasks
# numbered 1 to 10000.
#$ -t 1-5
...
echo ""
matlab -nosplash -nodesktop -nodisplay -nojvm -singleCompThread -r "NFDMsim"

# 13. Preferably, tar-up (archive) all output files onto the shared scratch area
tar zcvf $HOME/Scratch/Output/files_from_job_${JOB_ID}_${SGE_TASK_ID}.tgz $TMPDIR
